...
<head>
    ...
    <style>
        ...
        .bg-dibayar { background: #3498db; }
        .bg-selesai { background: #27ae60; }
        .bg-batal { background: #c0392b; }
        
        .btn-action { text-decoration: none; padding: 5px 8px; border-radius: 4px; color: white; font-size: 0.8rem; margin-right: 2px;}
        .btn-acc { background: #27ae60; }
        .btn-reject { background: #c0392b; }
        .btn-finish { background: #2980b9; }
    </style>
</head>
<body>
                ...
                <table class="custom-table" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <?php } 
                            ...
                            <tr><td colspan="6" style="text-align:center;">Tidak ada data janji temu.</td></tr>
                        <?php } ?>
                    </tbody>
                </table>
            </div>
